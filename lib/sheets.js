...
export async function getAllData() {
  ...
  const ranges = ['PRESUPUESTOS!A:AV','PROYECTOS!A:AQ','CARGAR STAFF!A:Z','FACTURACION!A:Z','RRHH!A:Z','Contactos/agencias!A:Z','PAGOS_STAFF!A:L','SUELDOS!A:J','LOG!A:F','COSTOS_PROYECTO!A:H','CUENTAS!A:H','RESERVAS!A:I']
