...
export async function getAllData() {
  ...
  // Rangos AMPLIADOS a MAX_SLOTS (40) servicios: PRESUPUESTOS A:DI, PROYECTOS A:ER.
  ...
  const ranges = ['PRESUPUESTOS!A:DI','PROYECTOS!A:ER','CARGAR STAFF!A:Z','FACTURACION!A:AG','RRHH!A:Z','Contactos/agencias!A:Z','PAGOS_STAFF!A:N','SUELDOS!A:J','LOG!A:F','COSTOS_PROYECTO!A:H','CUENTAS!A:N','RESERVAS!A:I','HISTORICO_2023!A:AE','HISTORICO_2024!A:AE','HISTORICO_2025!A:AE','COBROS!A:L','GASTOS_FIJOS!A:Q','TARJETAS!A:N','PRESTAMOS!A:O','MOVIMIENTOS_TARJETA!A:N','AGENCIAS!A:L','CLIENTES!A:J','listado!A:K','CUOTAS!A:K','MOVIMIENTOS!A:N']
