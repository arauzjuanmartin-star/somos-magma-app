...
export async function getAllData() {
  ...
  // PRESUPUESTOS llega hasta DS: DQ-DS son las 3 columnas del seguimiento comercial (lib/slots.js).
  const ranges = ['PRESUPUESTOS!A:DS','PROYECTOS!A:EW','CARGAR STAFF!A:Z','FACTURACION!A:AG','RRHH!A:Z','Contactos/agencias!A:Z','PAGOS_STAFF!A:Z','SUELDOS!A:J','LOG!A:F','COSTOS_PROYECTO!A:H','CUENTAS!A:N','RESERVAS!A:I','HISTORICO_2023!A:AE','HISTORICO_2024!A:AE','HISTORICO_2025!A:AE','COBROS!A:L','GASTOS_FIJOS!A:Q','TARJETAS!A:N','PRESTAMOS!A:T','MOVIMIENTOS_TARJETA!A:N','AGENCIAS!A:N','CLIENTES!A:M','listado!A:K','CUOTAS!A:K','MOVIMIENTOS!A:N','EDICION!A:AM','ACUERDOS!A:U','HORAS_EXTRA!A:M']
...
export { MAX_SLOTS, SLOT_PRESU, SLOT_PROY, ANCHO_PRESU, ANCHO_PROY, COL_DESGLOSAR, ANCHO_PRESU_FILA, COL_BRIEF_ED, HEADERS_BRIEF_ED, COL_SEGUIMIENTO, HEADERS_SEGUIMIENTO, ANCHO_PRESU_TOTAL, DIAS_SEGUIMIENTO } from './slots.js'
