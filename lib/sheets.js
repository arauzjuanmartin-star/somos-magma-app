...
export async function getAllData() {
  ...
  // PROYECTOS: rango AMPLIADO a A:CF para leer Staff 13..20 (cols BK..CF). Antes A:BH (60) cortaba en Staff 12.
  // Bug #1905 Minecraft: necesitaba cargar 13+ personas y la app solo leía 12 (los Staff 13-20 caían fuera del rango).
  const ranges = ['PRESUPUESTOS!A:BE','PROYECTOS!A:CF','CARGAR STAFF!A:Z','FACTURACION!A:AG','RRHH!A:Z','Contactos/agencias!A:Z','PAGOS_STAFF!A:N','SUELDOS!A:J','LOG!A:F','COSTOS_PROYECTO!A:H','CUENTAS!A:N','RESERVAS!A:I','HISTORICO_2023!A:AE','HISTORICO_2024!A:AE','HISTORICO_2025!A:AE','COBROS!A:L','GASTOS_FIJOS!A:Q','TARJETAS!A:N','PRESTAMOS!A:O','MOVIMIENTOS_TARJETA!A:N','AGENCIAS!A:L','CLIENTES!A:J','listado!A:K','CUOTAS!A:K','MOVIMIENTOS!A:N']
