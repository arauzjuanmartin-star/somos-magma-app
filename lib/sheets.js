...
export async function getAllData() {
  ...
  const ranges = ['PRESUPUESTOS!A:AX','PROYECTOS!A:AQ','CARGAR STAFF!A:Z','FACTURACION!A:AG','RRHH!A:Z','Contactos/agencias!A:Z','PAGOS_STAFF!A:L','SUELDOS!A:J','LOG!A:F','COSTOS_PROYECTO!A:H','CUENTAS!A:H','RESERVAS!A:I','HISTORICO_2023!A:AE','HISTORICO_2024!A:AE','HISTORICO_2025!A:AE','COBROS!A:L','GASTOS_FIJOS!A:L','TARJETAS!A:N','PRESTAMOS!A:K','MOVIMIENTOS_TARJETA!A:N','AGENCIAS!A:L','CLIENTES!A:J']
