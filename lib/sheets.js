...
export async function getAllData() {
  ...
  const ranges = ['PRESUPUESTOS!A:Z','PROYECTOS!A:Z','CARGAR STAFF!A:Z','FACTURACION!A:Z','RRHH!A:Z','listado!A:Z']
