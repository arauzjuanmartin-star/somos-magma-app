...
// La usa también el mail de los lunes (lib/lunes.mjs). Entiende título, subtítulo, viñetas y sub-viñetas ("  - ").
export function md2html(md){
  ...
  for (const raw of md.split('\n')) {
    ...
    if (l.startsWith('  - ')) { if(!enLista){out.push('<ul>');enLista=true} out.push(`<li style="margin-left:16px;color:#555;font-size:13.5px">${inline(l.slice(4))}</li>`); continue }
