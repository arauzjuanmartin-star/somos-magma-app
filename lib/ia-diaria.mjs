...
export const ITEMS_IA = [
  { que: 'Instalar **Claude in Chrome** (Chrome Web Store, con tu cuenta Max) y pedirle: "leeme los saldos de las tres cuentas y compará con la solapa CUENTAS".', min: 10 },
