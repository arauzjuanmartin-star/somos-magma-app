...
import { modulosDe, soloLoSuyoDe } from './roles'
...
const ENDPOINTS_POR_MODULO = {
  edicion:    ['edicion-guardar','edicion-sync','edicion-info','edicion-nuevo','horas-extra','drive-carpeta','drive-crudo-cliente','drive-fotos','data'],
...
export async function requireAuth(req, res) {
  ...
  return { mail, session, readOnly: isReadonly, modulos, soloLoSuyo: soloLoSuyoDe(mail) }
}
