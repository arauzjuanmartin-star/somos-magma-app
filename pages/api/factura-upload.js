...
const FOLDER_ROOT = '0AHMUebE7UIa_Uk9PVA'
...
export default async function handler(req, res) {
  ...
  try {
    ...
    let entidad = 'SRL', mes = '', anio = '', nroFactura = '', fileBuffer = null, fileName = 'factura.pdf', fileMime = 'application/pdf'
    ...
    // Mapear entidad a nombre de carpeta
    ...
    res.json({ ok: true, fileId: fileRes.data.id, link: fileRes.data.webViewLink })
  } catch(e) {
    console.error(e)
