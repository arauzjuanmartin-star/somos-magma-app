...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await withSheetsRetry(() => sheets.spreadsheets.values.batchGet({
      ...
      ranges: ['PRESUPUESTOS!A:DI', 'PROYECTOS!A:ER', 'FACTURACION!A:AG', 'PRESTAMOS!A:T', 'PAGOS_STAFF!A:Z', 'TARJETAS!A:N', 'MOVIMIENTOS_TARJETA!A:N', 'AGENCIAS!A:L', 'Contactos/agencias!A:Z'],
